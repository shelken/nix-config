...
let
  ...
  combine-user =
    origin-set: user-set: (lib.attrsets.mapAttrs (_name: value: value // user-set) origin-set);
  nix-host = combine-user (combine-net {
